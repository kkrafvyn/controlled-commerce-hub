-- Separate admin toggles for pay-shipping-later on group buy and flash sale checkouts.

INSERT INTO public.store_settings (key, value)
VALUES
  ('deferShippingPaymentGroupBuyEnabled', 'false'::jsonb),
  ('deferShippingPaymentFlashSaleEnabled', 'false'::jsonb)
